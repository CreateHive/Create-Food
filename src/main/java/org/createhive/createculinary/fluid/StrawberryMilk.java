...
public class StrawberryMilk extends FlowableFluid {
    public StrawberryMilk() {
    }

    public Fluid getFlowing() {
        return ModFluids.STRAWBERRY_MILK_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.STRAWBERRY_MILK_STILL;
    }

    public Item getBucketItem() {
        return ModItems.STRAWBERRY_MILK_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) ModBlocks.STRAWBERRY_MILK_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.STRAWBERRY_MILK_STILL || fluid == ModFluids.STRAWBERRY_MILK_FLOWING;
    }
    ...
    public static class Flowing extends StrawberryMilk {
        public Flowing() {
        }
    ...
    public static class Still extends StrawberryMilk {
        public Still() {
        }
