...
public class BananaMilk extends FlowableFluid {
    public BananaMilk() {
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) ModBlocks.BANANA_MILK_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.BANANA_MILK_STILL || fluid == ModFluids.BANANA_MILK_FLOWING;
    }
    ...
    public static class Still extends BananaMilk {
        public Still() {
        }
