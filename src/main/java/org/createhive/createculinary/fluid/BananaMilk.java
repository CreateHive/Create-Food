...
public class BananaMilk extends FlowableFluid {
    ...
    public Fluid getFlowing() {
        return ModFluids.BANANA_MILK_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.BANANA_MILK_STILL;
    }

    public Item getBucketItem() {
        return ModItems.BANANA_MILK_BUCKET;
    }
    ...
    public static class Flowing extends BananaMilk {
        public Flowing() {
        }
