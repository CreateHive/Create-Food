...
public class ChocolateMilk extends FlowableFluid {
    ...
    public Item getBucketItem() {
        return ModItems.CHOCOLATE_MILK_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return (BlockState) ModBlocks.CHOCOLATE_MILK_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }
    ...
    public static class Flowing extends ChocolateMilk {
        public Flowing() {
        }
    ...
    public static class Still extends ChocolateMilk {
        public Still() {
        }
